<div class="row">
    <div class="col-md-6">
        <div class="mb-4">
            ...
            <input type="text" name="settings[site_name]" value="<?php echo $settings['site_name'] ?? ''; ?>" class="form-control" placeholder="Введите название сайта" required>
    ...
    <div class="col-md-6">
        <div class="mb-4">
            ...
            <input type="text" name="settings[site_tagline]" value="<?php echo $settings['site_tagline'] ?? ''; ?>" class="form-control" placeholder="Краткое описание вашего блога">
