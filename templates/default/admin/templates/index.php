        ...
        <div class="col-md-3 mb-4">
            ...
            <div class="card border-0 shadow-sm mt-3">
                <div class="card-header bg-white border-0 d-flex justify-content-between align-items-center">
                    ...
                    <small class="text-muted ms-2" id="cacheStatus"></small>
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-4 mt-2">
                            ...
                            <span id="infoFileUpdated" class="text-muted">-</span>
                        </div>
                    </div>
                </div>
            </div>
...
function loadTemplateFiles(template) {
    ...
    cacheStatus.textContent = 'загрузка...';
    ...
    fetch(`<?php echo ADMIN_URL; ?>/templates/get-files?template=${template}`)
        ...
        .then(files => {
            ...
            if (loadTime < 50) {
                cacheStatus.textContent = '⚡ из кэша';
                cacheStatus.className = 'text-success ms-2';
            } else {
                cacheStatus.textContent = '🔄 обновлено';
                cacheStatus.className = 'text-muted ms-2';
            }
        ...
        .catch(error => {
            ...
            cacheStatus.textContent = '❌ ошибка';
            cacheStatus.className = 'text-danger ms-2';
        });
}
...
function updateFileInfo(info, filePath) {
    ...
    if (info.updated_at) {
        ...
        document.getElementById('infoFileUpdated').textContent = 
