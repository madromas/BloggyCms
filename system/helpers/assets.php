...
* @param bool $clear Очищать ли очередь после вывода
* @return string HTML с CSS
*/
if (!function_exists('render_front_css')) {
    function render_front_css(bool $clear = false): string {
        return AssetManager::getInstance()->renderCss('frontend', $clear);
    }
}
...
/**
* @deprecated Используем front_css()
*/
...
/**
* @deprecated Используем front_js()
*/
...
/**
* @deprecated Используем front_inline_css() или admin_inline_css()
*/
...
/**
* @deprecated Используем front_inline_js() или admin_inline_js()
*/
...
/**
* @deprecated Используем admin_css()
*/
...
/**
* @deprecated Используем admin_js()
*/
